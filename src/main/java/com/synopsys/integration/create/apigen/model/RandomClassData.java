...
import static com.synopsys.integration.create.apigen.data.UtilStrings.COMPONENT_DIRECTORY_SUFFIX;
import static com.synopsys.integration.create.apigen.data.UtilStrings.CORE_CLASS_PATH_PREFIX;
import static com.synopsys.integration.create.apigen.data.UtilStrings.GENERATED_COMPONENT_PACKAGE;
import static com.synopsys.integration.create.apigen.data.UtilStrings.GENERATED_RESPONSE_PACKAGE;
import static com.synopsys.integration.create.apigen.data.UtilStrings.GENERATED_VIEW_PACKAGE;
import static com.synopsys.integration.create.apigen.data.UtilStrings.RESPONSE_BASE_CLASS;
import static com.synopsys.integration.create.apigen.data.UtilStrings.RESPONSE_DIRECTORY_SUFFIX;
import static com.synopsys.integration.create.apigen.data.UtilStrings.VIEW_BASE_CLASS;
import static com.synopsys.integration.create.apigen.data.UtilStrings.VIEW_DIRECTORY_SUFFIX;
